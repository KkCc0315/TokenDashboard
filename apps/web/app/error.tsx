  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-xl rounded-[28px] border border-slate-200 bg-white/90 p-8 shadow-soft">
        <p className="text-xs uppercase tracking-[0.3em] text-rose-500">Something went wrong</p>
        <h1 className="mt-3 text-2xl font-semibold text-ink">{error.message || "An unexpected error occurred"}</h1>
        <p className="mt-3 text-sm text-slate-600">
          The page could not be rendered. You can try again or return to the dashboard.
        </p>
